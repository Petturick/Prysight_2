...
export const FEED_TARGET_FIELDS = [
  ...
  { key: 'name', label: 'Productnaam' }, { key: 'description', label: 'Omschrijving' }, { key: 'imageUrl', label: 'Productafbeelding URL' }, { key: 'productGroup', label: 'Productgroep' },
  { key: 'ownPrice', label: 'Eigen prijs' }, { key: 'vatIncluded', label: 'Prijs inclusief btw' },
  { key: 'ownShippingCost', label: 'Eigen verzendkosten' }, { key: 'ownShippingVatIncluded', label: 'Verzendkosten inclusief btw' }, { key: 'costPrice', label: 'Kostprijs' }, { key: 'minimumMarginPct', label: 'Minimale marge %' },
...
export const FIELD_ALIASES: Record<string, string[]> = {
  ...
  imageUrl: ['image','imageurl','image_url','productimage','product_image','image_link','imagelink','afbeelding','afbeeldingurl','afbeelding_url'],
  ownShippingCost: ['ownshippingcost','own_shipping_cost','shippingcost','shipping_cost','verzendkosten','deliverycost','delivery_cost'],
  ownShippingVatIncluded: ['ownshippingvatincluded','own_shipping_vat_included','shippingvatincluded','shipping_vat_included','verzendkosteninclusiefbtw'],
