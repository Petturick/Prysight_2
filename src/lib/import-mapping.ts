...
export const FEED_TARGET_FIELDS = [
  ...
  { key: 'ownPrice', label: 'Eigen prijs' }, { key: 'costPrice', label: 'Kostprijs' }, { key: 'minimumMarginPct', label: 'Minimale marge %' },
...
export const FIELD_ALIASES: Record<string, string[]> = {
  ...
  ownPrice: ['ownprice','own_price','price','salesprice','sales_price','sellingprice','verkoopprijs','prijs','brutoprijs','eigenprijs'], costPrice: ['costprice','cost_price','cost','inkoopprijs','kostprijs','purchaseprice','purchase_price'],
