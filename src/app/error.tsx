    ...
    <div className="mx-auto max-w-3xl rounded-[10px] border border-[#e2e7ee] bg-white p-6 shadow-[0_2px_9px_rgba(31,49,77,.045)]">
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h1 className="mt-2 text-[24px] font-bold tracking-[-.025em] text-[#17233a]">De pagina kon niet worden geladen</h1>
          <p className="mt-3 max-w-2xl text-[12px] leading-6 text-[#718096]">Er ging iets mis tijdens het ophalen van deze pagina. Probeer het opnieuw. Blijft dit gebeuren, geef de foutcode door aan de beheerder.</p>
