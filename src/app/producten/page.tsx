            ...
            return (
              <article key={item.product.id} className="ps-panel overflow-hidden">
                ...
                <div className="grid border-t border-[#e7edf3] sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-7">
                  ...
                  <div className="px-4 py-3"><p className="text-[9px] font-black uppercase tracking-[.06em] text-[#7a8898]">Bronnen</p><p className="mt-1 text-[15px] font-black text-[#24384f]">{formatNumber(item.offerCount)}</p><p className="mt-1 text-[9px] font-semibold text-[#8190a1]">{item.validMatches} bevestigd</p></div>
