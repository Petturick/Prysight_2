          ...
          <div className="border-b border-[#e7edf3] bg-[#f8fbff] p-5 sm:p-6 lg:border-b-0 lg:border-r">
            <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-1">
              <div>
                ...
                <p className="mt-1 text-[24px] font-semibold tracking-[-0.02em] text-[#1e2d3f]">{formatCurrency(comparisonOwnPriceExVat, ownCurrency)}</p>
              </div>
              <div>
                <p className="text-[10px] font-semibold uppercase tracking-[0.06em] text-[#8492a3]">Inclusief btw</p>
                <p className="mt-1 text-[24px] font-semibold tracking-[-0.02em] text-[#1e2d3f]">{formatCurrency(comparisonOwnPrice, ownCurrency)}</p>
              </div>
            </div>
            <p className="mt-3 text-[10px] text-[#7b8999]">
              {defaultCountry ? `${formatNumber(vatRate, 2)}% btw · ${defaultCountry.name}` : 'Geen markt geselecteerd'}
