...
export default async function ActionsPage() {
  ...
  const total = result.data.alerts + result.data.reviewMatches + result.data.failedChecks + result.data.staleOffers + result.data.priceChanges
  const cards = [
    { label: 'Prijsgoedkeuringen', value: result.data.priceChanges, helper: 'Aanvragen, goedgekeurde wijzigingen of mislukte publicaties', href: '/prijswijzigingen', urgent: result.data.priceChanges > 0 },
