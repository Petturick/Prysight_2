...
export default async function PriceExplanationPage({ searchParams }: { searchParams: Promise<Record<string,string|string[]|undefined>> }) {
  ...
  return <div className="space-y-5">
    <section className="strong-panel p-5 sm:p-6"><p className="eyebrow">Uitlegbare pricing</p><h1 className="mt-2 text-[28px] font-semibold tracking-[-.035em]">Waarom deze prijs?</h1><p className="mt-2 max-w-3xl text-[12px] leading-6 text-[#697386]">Iedere aanbeveling laat zien welke marktdata, prijsregel, marge en guardrails de uitkomst bepalen. Automatic gebruikt exact dezelfde uitleg en grenzen.</p><Link href="/prijsstrategie" className="secondary-action mt-4">Terug naar prijsstrategie</Link></section>
