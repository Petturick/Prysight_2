    ...
    <div className="space-y-5">
      ...
      <section className="strong-panel overflow-hidden">
        <div className="flex flex-col gap-5 px-5 py-5 sm:flex-row sm:items-end sm:justify-between sm:px-6">
          ...
          <div className="flex flex-wrap gap-2"><Link href="/import/bulk" className="primary-action">Bulk productfeed</Link><Link href="/feeds" className="ps-button-orange">Doorlopende feed</Link><Link href="/producten" className="secondary-action">Producten bekijken</Link></div>
        </div>
      ...
      <section className="grid gap-3 md:grid-cols-3">
        <Link href="/import/bulk" className="ps-panel p-4"><div className="flex h-9 w-9 items-center justify-center rounded-[10px] bg-[#e8f2ff] text-[11px] font-black text-[#2f7edb]">1</div><h2 className="mt-3 text-[14px] font-black text-[#2c4058]">Bulk productfeed</h2><p className="mt-1.5 text-[10px] font-semibold leading-5 text-[#748296]">Voor complete catalogi en horizontale prijsrapporten met automatische productherkenning.</p><p className="mt-3 text-[10px] font-black text-[#2f7edb]">Open bulkimport →</p></Link>
