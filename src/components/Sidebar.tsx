...
const groups: Array<{ label?: string; items: NavItem[] }> = [
  ...
  { label: 'Analyse & rapportage', items: [{ href: '/rapportages', label: 'Rapportages', icon: 'reports' }] },
